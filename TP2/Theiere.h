...
public:
    ...
    MatricePipeline obtenirMatriceCourante( )
    {
        ...
        // std::cout << "//@Theiere, obtenirMatriceCourante;" << " determinant=" << glm::determinant( glm::mat4(m) ) << std::endl;
        return mtc;
    }
    ...
    void afficher()
    {
        matrModel.PushMatrix(); { // sauvegarder la transformation courante
            ...
            matrModel.PushMatrix(); {
                // tourner la théière pour avoir son bec (la direction X) dans la bonne direction
